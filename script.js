...
const experienceData = [
  {
    title: "Cybersecurity & Web Application Security Practice",
    period: "Authorized labs | Approximately 1 year",
    items: [
      "Performed structured exercises against controlled web applications to identify common weaknesses and understand their technical impact.",
      "Reviewed authentication, authorization, user input, sessions, cookies, HTTP requests and responses, headers, and API endpoints.",
      "Applied OWASP Top 10 concepts to recognize broken access control, injection, cross-site scripting, insecure design, and security misconfiguration.",
      "Documented findings with concise impact analysis and remediation-oriented guidance.",
    ],
  },
  {
    title: "Network Enumeration & Traffic Analysis",
    period: "Authorized practice environments",
    items: [
      "Used Nmap for host discovery, port scanning, service enumeration, and basic exposure analysis in permitted environments.",
      "Used Wireshark to capture and inspect TCP connections, DNS queries, HTTP traffic, and protocol behavior.",
      "Analyzed network services and packet-level communication to strengthen understanding of application and infrastructure attack surfaces.",
    ],
  },
  {
    ...
    period: "2023 - Present",
    items: [
      "Built responsive interfaces with React, Bootstrap, and Tailwind CSS.",
      "Developed backend services with Laravel and FastAPI.",
      "Designed RESTful APIs and applied server-side validation, structured error handling, authentication and authorization concepts, and secure database access practices.",
      "Used knowledge of application architecture and data flow to understand how implementation flaws become security vulnerabilities.",
    ],
  },
  {
    title: "Database, Desktop Development & Problem Solving",
    period: "2023 - Present",
    items: [
      "Designed relational schemas and ERD diagrams and implemented MySQL and SQL databases using indexing, query optimization, and integrity constraints.",
      "Developed Windows applications with C# and Windows Forms.",
      "Solved algorithmic problems in C++, strengthening debugging and analytical problem-solving skills.",
    ],
  },
];
...
const projectsData = [
  ...
  },
  {
    ...
    desc: "RESTful task-management API built with Laravel 12, featuring Laravel Sanctum authentication, user roles, categories, favorites, profile management, server-side validation, and structured authorization logic.",
    tech: ["laravel", "api"],
    category: "Laravel",
  ...
  {
    title: "AlgoMotion",
    desc: "An interactive algorithm visualizer built with AI coding tools to explain sorting algorithms and data structures through step-by-step animations and live pseudocode highlighting. Built with client-side HTML, CSS, and JavaScript with no dependencies.",
    tech: ["HTML", "CSS", "JS"],
    category: "HTML & CSS",
    ...
    {
    title: "FavoraBlog",
    desc: "FavoraBlog is a modern single-page blog app for discovering posts, viewing details, and saving favorite reads locally in the browser with a polished responsive UI.",
    tech: ["HTML", "CSS", "JS"],
    category: "HTML & CSS",
    image: "images/FavoraBlog.png",
    github: "https://github.com/Mohammed-Hijazi/FavoraBlog",
    demo: "https://mohammed-hijazi.github.io/FavoraBlog/",
  },

  {
    ...
    github:
      "https://github.com/Mohammed-Hijazi/University-Library-Management-System-Java",
    demo: "#",
  },
];
...
const certificatesData = [
  ...
  },
  {
    ...
    org: "Individual participation certificate recognizing involvement in competitive programming and algorithmic problem solving through the International Collegiate Programming Contest environment.",
    image: "images/MY-ICPC.png",
  },
  {
    title: "ICPC Team Participation Certificate",
    org: "Team participation certificate recognizing collaborative competitive-programming experience, coordination, analytical thinking, and algorithmic problem solving.",
...
const contactData = [
  {
    ...
    label: "GitHub",
    value: "github.com/mohammedhijazi",
  ...
  },
  {
    ...
    label: "Codeforces",
    value: "codeforces.com/profile",
    link: "https://codeforces.com/profile/mohammed_hiz",
  },
  {
    ...
    label: "LinkedIn",
    value: "linkedin.com/in/mohammedhijazi",
    link: "https://www.linkedin.com/in/mohammed-hijazi-445a89314/",
  },
  {
    ...
    label: "Email",
    value: "mohammedhiz1113@gmail.com",
    link: "mailto:mohammedhiz1113@gmail.com",
  },
  {
    ...
    label: "WhatsApp",
    value: "+84 39 296 6551",
    link: "https://wa.me/84392966551",
  },
];
...
const translations = {
  en: {
    ...
    hero: {
      badge: "Open to Junior Cybersecurity Opportunities",
      name: "Mohammed Hijazi",
      subtitle: "Junior Web Application Penetration Tester | Cybersecurity Analyst",
      desc: "Information Engineering student with approximately one year of hands-on cybersecurity learning and authorized lab practice focused on web application security, vulnerability assessment, system analysis, and secure software development.",
    ...
    about: {
      ...
      p1: "Information Engineering student with approximately one year of hands-on cybersecurity learning and authorized lab practice focused on web application security, system analysis, and vulnerability assessment.",
      p2: "Foundational-to-intermediate knowledge of the OWASP Top 10, HTTP/HTTPS, authentication, authorization, input validation, and network fundamentals. Full-stack experience with React, Laravel, FastAPI, and relational databases supports practical analysis of application architecture, APIs, data flows, and common security weaknesses.",
      expYears: "Year Security Practice",
      projects: "Top 10 Knowledge",
      technologies: "Security Tools",
    },
    skills: {
      label: "Cybersecurity Skills",
      title: "Core Cybersecurity Competencies",
    },
    experience: {
      label: "Technical Experience",
      title: "Security & Development Practice",
    },
    projects: { label: "Projects", title: "Selected Development Projects" },
    certificates: { label: "Training", title: "Education & Certifications" },
    education: {
      title: "Education",
  ...
  ar: {
    ...
    hero: {
      badge: "متاح لفرص الأمن السيبراني للمستوى المبتدئ",
      name: "محمد حجازي",
      subtitle: "مختبر اختراق تطبيقات ويب مبتدئ | محلل أمن سيبراني",
      desc: "طالب هندسة معلوماتية أمتلك قرابة عام من التعلم العملي في الأمن السيبراني والتدريب ضمن مختبرات مصرح بها، مع تركيز على أمن تطبيقات الويب، وتقييم الثغرات، وتحليل الأنظمة، وتطوير البرمجيات الآمنة.",
      viewProjects: "عرض الخبرات",
      contactMe: "تواصل معي",
    },
    about: {
      label: "الملخص المهني",
      title: "الملف المهني في الأمن السيبراني",
      p1: "طالب هندسة معلوماتية أمتلك قرابة عام من التعلم العملي في الأمن السيبراني والتدريب ضمن مختبرات مصرح بها، مع تركيز على أمن تطبيقات الويب، وتحليل الأنظمة، وتقييم الثغرات.",
      p2: "أمتلك معرفة من المستوى التأسيسي إلى المتوسط بمخاطر OWASP Top 10 وبروتوكولات HTTP وHTTPS والمصادقة والصلاحيات والتحقق من المدخلات وأساسيات الشبكات. كما تساعدني خبرتي في React وLaravel وFastAPI وقواعد البيانات العلائقية على تحليل بنية التطبيقات وواجهات API وتدفق البيانات ونقاط الضعف الشائعة.",
      expYears: "عام من التدريب الأمني",
      projects: "معرفة OWASP Top 10",
      technologies: "أداتان أمنيتان",
    },
    skills: {
      label: "مهارات الأمن السيبراني",
      title: "الكفاءات الأساسية في الأمن السيبراني",
    },
    experience: {
      label: "الخبرة التقنية",
      title: "التدريب الأمني وخبرة التطوير",
    },
    projects: { label: "المشاريع", title: "مشاريع تطوير مختارة" },
    certificates: { label: "التدريب", title: "التعليم والشهادات" },
    education: {
      title: "التعليم",
...
document.addEventListener("mouseover", (e) => {
  if (
    e.target.closest(
      "a, button, .project-card, .certificate-card, .skill-tag, .stat-card",
    )
  ) {
